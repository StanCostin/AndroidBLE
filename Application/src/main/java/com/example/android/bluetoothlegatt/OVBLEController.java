...
public class OVBLEController extends AppCompatActivity {

    private final static String TAG = OVBLEController.class.getSimpleName();
    public static final String EXTRAS_DEVICE_NAME = "DEVICE_NAME";
    public static final String EXTRAS_DEVICE_ADDRESS = "DEVICE_ADDRESS";
    private ImageButton onOVBtn;
    private ImageButton offOVBtn;
    private ImageButton discOVBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ovblecontroller);

        final Intent intent = getIntent();
        mDeviceName = intent.getStringExtra(EXTRAS_DEVICE_NAME);
        mDeviceAddress = intent.getStringExtra(EXTRAS_DEVICE_ADDRESS);

        onOVBtn = findViewById(R.id.onOVId);
        offOVBtn = findViewById(R.id.offOVId);
        discOVBtn = findViewById(R.id.discOVID);


        Intent gattServiceIntent = new Intent(this, BluetoothLeService.class);
        bindService(gattServiceIntent, mServiceConnection, BIND_AUTO_CREATE);

        onOVBtn.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        offOVBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String value = "X";
                mBluetoothLeService.writeCharacteristic(bluetoothGattCharacteristicBLE, value);
        ...
        discOVBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                goBackOVMC();
            }
